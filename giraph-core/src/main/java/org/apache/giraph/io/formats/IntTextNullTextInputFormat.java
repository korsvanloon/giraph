 ...
 */
public class IntTextNullTextInputFormat extends TextVertexInputFormat<
        IntWritable, Text, NullWritable> {
  @Override
  ...
  public class IntNullNullNullVertexReader extends
    ...
    @Override
    protected Text getValue(String line) throws IOException {
      return new Text("");
    }
